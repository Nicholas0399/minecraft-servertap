...
public final class WebServerRoutes {
    ...
    public static void addV1Routes(ServerTapMain main, Logger log, LagDetector lagDetector, WebServer webServer,
        ...
        pr.get("players/{uuid}/tiktok-status", api.getPlayerApi()::playerTikTokStatus);
        pr.put("tiktok/status", api.getPlayerApi()::updateTikTokStatus);
        pr.get("tiktok/streamers", api.getPlayerApi()::listTikTokStreamers);
