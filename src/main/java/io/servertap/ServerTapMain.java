...
public class ServerTapMain extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        MojangApiService mojangApiService = new MojangApiService();
        webhookEventListener = new WebhookEventListener(this, bukkitConfig, log, externalPluginWrapperRepo.getEconomyWrapper(), mojangApiService);
